...
void realizable(int A[], int n, int T)
{
    int S, s, i, j;
    char *P;
    / P[i][j] stores 0 if unrealizable, or + / -if realizable * /
...
void showall(int A[], int n, int T)
{
    ...
    char **sol;
    int *P;
    / P[i][j] stores how many times j is realizable with + a[i] * /
                                                               int *Q;
    / Q[i][j] stores how many times j is realizable with - a[i] * /
